...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    vec![
        Menu {
            ...
            disabled: false,
            items: vec![
                MenuItem::action("About Ribhu", zed_actions::About),
                ...
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Ribhu", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Ribhu", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action(
                    "Report an Issue...",
                    super::OpenBrowser {
                        url: "https://github.com/ShreyanshVaibhaw/zed/issues/new/choose".into(),
                    },
                ),
                MenuItem::separator(),
                MenuItem::action(
                ...
                MenuItem::action(
                    "Ribhu Repository",
                    super::OpenBrowser {
                        url: "https://github.com/ShreyanshVaibhaw/zed".into(),
                    },
                ),
            ],
        },
