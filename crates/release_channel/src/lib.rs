...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Ribhu-Editor-Dev",
        ReleaseChannel::Nightly => "Ribhu-Editor-Nightly",
        ReleaseChannel::Preview => "Ribhu-Editor-Preview",
        ReleaseChannel::Stable => "Ribhu-Editor-Stable",
    }
}
...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "Ribhu Dev",
            ReleaseChannel::Nightly => "Ribhu Nightly",
            ReleaseChannel::Preview => "Ribhu Preview",
            ReleaseChannel::Stable => "Ribhu",
        }
    }
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "dev.ribhu.Ribhu-Dev",
            ReleaseChannel::Nightly => "dev.ribhu.Ribhu-Nightly",
            ReleaseChannel::Preview => "dev.ribhu.Ribhu-Preview",
            ReleaseChannel::Stable => "dev.ribhu.Ribhu",
        }
    }
